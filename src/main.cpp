...
int64_t GetProofOfStakeRewardPercent(int nHeight)
{
    ...
    if (nHeight > 39000001) // ...........................Block  40.000.000 - 0.125% POS
        nRewardCoinYear = COIN_YEAR_REWARD_V40;
	else if (nHeight >= 38000001 && nHeight <= 39000000) // Block 39.000.000 - 0.125% POS  
	...
	else if (nHeight >= 33000001 && nHeight <= 34000000) // Block 34.000.000 - 0.25% POS  
		nRewardCoinYear = COIN_YEAR_REWARD_V34;
	else if (nHeight >= 32000001 && nHeight <= 33000000) // Block 33.000.000 - 0.25% POS  
	...
	else if (nHeight >= 28000001 && nHeight <= 29000000) // Block 29.000.000 - 0.5% POS      
        nRewardCoinYear = COIN_YEAR_REWARD_V29;
	else if (nHeight >= 27000001 && nHeight <= 28000000) // Block 28.000.000 - 0.5% POS      
    ...
    else if (nHeight >= 11000001 && nHeight <= 12000000) // Block 12.000.000 - 1% POS      
        nRewardCoinYear = COIN_YEAR_REWARD_V12; 
    else if (nHeight >= 10000001 && nHeight <= 11000000) // Block 11.000.000 - 1% POS      
    ...
    else if (nHeight >= 8000001 && nHeight <= 9000000) // Block 9.000.000 - 2% POS     
        nRewardCoinYear = COIN_YEAR_REWARD_V9;    
    else if (nHeight >= 7000001 && nHeight <= 8000000) // Block 8.000.000 - 2% POS
        nRewardCoinYear = COIN_YEAR_REWARD_V8;    
    else if (nHeight >= 6000001 && nHeight <= 7000000) // Block 7.000.000 3% POS
        nRewardCoinYear = COIN_YEAR_REWARD_V7;    
    else if (nHeight >= 5000001 && nHeight <= 6000000) // Block 6.000.000 5% POS
        nRewardCoinYear = COIN_YEAR_REWARD_V6;    
    else if (nHeight >= 4000001 && nHeight <= 5000000) // Block 5.000.000 6% POS
        nRewardCoinYear = COIN_YEAR_REWARD_V5;
    else if (nHeight >= 3000001 && nHeight <= 4000000) // Block 4.000.000 8% POS
        nRewardCoinYear = COIN_YEAR_REWARD_V4;
    else if (nHeight >= 2000001 && nHeight <= 3000000) // Block 3.000.000 10% POS
        nRewardCoinYear = COIN_YEAR_REWARD_V3;       
    else if (nHeight >= 1000000 && nHeight <= 2000000) // Block 2.000.000 12% POS
        nRewardCoinYear = COIN_YEAR_REWARD_V2;
    else if (nHeight < 1000000) //....................... Block   1.000.000 15% POS
